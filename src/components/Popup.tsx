...
const Popup: React.FC<PopupProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-transparent bg-opacity-30 backdrop-blur-md flex items-center justify-center z-50">
      <div className="relative bg-gradient-to-br from-blue-500 to-purple-600 p-6 rounded-xl shadow-2xl max-w-lg w-full mx-4 transform transition-all duration-500 scale-100 hover:scale-105 flex">
        ...
        <div className="w-2/3 pl-6 flex flex-col justify-center">
          ...
          <button
            onClick={onClose}
            className="absolute top-4 right-4 text-white hover:text-blue-200 transition-all duration-300"
          >
